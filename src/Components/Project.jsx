export default function Project(props) {
  return (
    <div className="w-[380px] h-fit border-neutral-200 bg-neutral-50 rounded-lg pb-2 pt-0.5 text-neutral-900 no-underline dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100  hover:scale-105 transition-all hover:rotate-6 duration-300 border shadow-2xl">
